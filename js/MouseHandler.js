...
var MouseHandler = (function() {
	...
	function mkParams(e,eventName) {
	    e.params = { name : eventName, pos : relPos(e), button : mouseButton, leftButton : mouseButton==0, middleButton : mouseButton==1, rightButton : mouseButton==2, mouseDownPos : mouseDownPos, draggedFrom : mouseDragPos };
	    return e;
	}
